...
public class EarthquakeCityMap extends PApplet {
	...
	private void sortAndPrint(int numToPrint) {
		numToPrint = (numToPrint > quakeMarkers.size()) ? quakeMarkers.size() : numToPrint;
	...
	private void addKey() {
		...
		triangle(tri_xbase, tri_ybase - CityMarker.TRI_SIZE, tri_xbase - CityMarker.TRI_SIZE, tri_ybase + CityMarker.TRI_SIZE,
				tri_xbase + CityMarker.TRI_SIZE, tri_ybase + CityMarker.TRI_SIZE);
